...
class Ui_Signup(object):
    ...
    def retranslateUi(self, Signup):
        Signup.setWindowTitle(QCoreApplication.translate(
            "Signup", u"\u7528\u6237\u6ce8\u518c", None))
        ...
        self.sign.setStyleSheet(QCoreApplication.translate("Signup", u"\n"
                                                           ...
                                                           "          }\n"
                                                           "        ", None))
        self.sign.setText(QCoreApplication.translate(
            "Signup", u"\u6ce8\u518c", None))
        self.username.setText("")
        self.username.setPlaceholderText(QCoreApplication.translate(
            "Signup", u"\u8f93\u5165\u7528\u6237\u540d", None))
        self.passwords1.setPlaceholderText(QCoreApplication.translate(
            "Signup", u"\u8bf7\u8f93\u5165\u5bc6\u7801", None))
        self.passwords2.setText("")
        self.passwords2.setPlaceholderText(QCoreApplication.translate(
            "Signup", u"\u8bf7\u518d\u6b21\u8f93\u5165\u5bc6\u7801", None))
