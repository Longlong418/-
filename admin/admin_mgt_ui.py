...
class Ui_admin_mgt(object):
    def setupUi(self, admin_mgt):
        ...
        sizePolicy.setHeightForWidth(
            admin_mgt.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, admin_mgt):
        admin_mgt.setWindowTitle(QCoreApplication.translate(
            "admin_mgt", u"\u4fe1\u606f\u7ba1\u7406", None))
        ...
        self.search_admin.setPlaceholderText(
            QCoreApplication.translate("admin_mgt", u"\u641c\u7d22", None))
        self.search.setText("")
    # retranslateUi
