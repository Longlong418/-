...
class Ui_data_info(object):
    def setupUi(self, data_info):
        ...
        data_info.setStyleSheet(u" #data_info{background: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #4DA2CB, stop:1 #67B26F);}")
    ...
    def retranslateUi(self, data_info):
        data_info.setWindowTitle(QCoreApplication.translate("data_info", u"\u6570\u636e\u96c6\u4fe1\u606f", None))
        self.label_2.setText(QCoreApplication.translate("data_info", u"\u6570\u636e\u96c6\u4fe1\u606f", None))
        self.label.setText(QCoreApplication.translate("data_info", u"\u6d4b\u8bd5\u96c6\uff1a", None))
        self.label_3.setText(QCoreApplication.translate("data_info", u"\u8def\u5f84:", None))
        self.label_10.setText(QCoreApplication.translate("data_info", u"\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014\u2014", None))
        self.label_4.setText(QCoreApplication.translate("data_info", u"\u8bad\u7ec3\u96c6\uff1a", None))
        self.test_path.setText(QCoreApplication.translate("data_info", u"\u7a7a", None))
        self.label_6.setText(QCoreApplication.translate("data_info", u"\u6837\u672c\u603b\u6570\uff1a", None))
        self.label_7.setText(QCoreApplication.translate("data_info", u"\u7ef4\u5ea6:", None))
        self.test_sum.setText(QCoreApplication.translate("data_info", u"\u7a7a", None))
        self.test_dim.setText(QCoreApplication.translate("data_info", u"\u7a7a", None))
        self.label_8.setText(QCoreApplication.translate("data_info", u"\u6837\u672c\u603b\u6570\uff1a", None))
        self.train_dim.setText(QCoreApplication.translate("data_info", u"\u7a7a", None))
        self.label_5.setText(QCoreApplication.translate("data_info", u"\u8def\u5f84:", None))
        self.train_path.setText(QCoreApplication.translate("data_info", u"\u7a7a", None))
        self.label_9.setText(QCoreApplication.translate("data_info", u"\u7ef4\u5ea6:", None))
        self.train_sum.setText(QCoreApplication.translate("data_info", u"\u7a7a", None))
        self.username.setText(QCoreApplication.translate("data_info", u"\u7531\"\u7528\u6237\u540d\"\u4e0a\u4f20", None))
    # retranslateUi
