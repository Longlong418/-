...
class Ui_user_login(object):
    def setupUi(self, user_login):
        ...
        sizePolicy.setHeightForWidth(user_login.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, user_login):
        user_login.setWindowTitle(QCoreApplication.translate("user_login", u"\u7528\u6237\u767b\u5f55", None))
...
"        }\n"
"      ", None))
        self.label.setText(QCoreApplication.translate("user_login", u"\u7528\u6237\u767b\u5f55", None))
...
"        ", None))
        ...
        self.username.setPlaceholderText(QCoreApplication.translate("user_login", u"\u8f93\u5165\u60a8\u7684\u7528\u6237\u540d", None))
...
"        ", None))
        ...
        self.passwords.setPlaceholderText(QCoreApplication.translate("user_login", u"\u8f93\u5165\u60a8\u7684\u5bc6\u7801", None))
...
"          }\n"
"        ", None))
        self.login.setText(QCoreApplication.translate("user_login", u"\u767b\u5f55", None))
