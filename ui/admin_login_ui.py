...
class Ui_admin_login(object):
    def setupUi(self, admin_login):
        ...
        sizePolicy.setHeightForWidth(admin_login.sizePolicy().hasHeightForWidth())
...
"        ")
    ...
    def retranslateUi(self, admin_login):
        admin_login.setWindowTitle(QCoreApplication.translate("admin_login", u"\u7ba1\u7406\u5458\u767b\u9646", None))
...
"          }\n"
"        ", None))
        self.label.setText(QCoreApplication.translate("admin_login", u"\u7ba1\u7406\u5458\u767b\u5f55", None))
...
"          }\n"
"        ", None))
        self.login.setText(QCoreApplication.translate("admin_login", u"\u767b\u5f55", None))
        self.adname.setText("")
        self.adname.setPlaceholderText(QCoreApplication.translate("admin_login", u"\u8f93\u5165\u60a8\u7684\u7ba1\u7406\u5458\u540d", None))
        self.passwords.setText("")
        self.passwords.setPlaceholderText(QCoreApplication.translate("admin_login", u"\u8f93\u5165\u60a8\u7684\u5bc6\u7801", None))
    # retranslateUi
