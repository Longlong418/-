...
class Ui_result(object):
    ...
    def retranslateUi(self, result):
        result.setWindowTitle(QCoreApplication.translate("result", u"\u8bad\u7ec3\u7ed3\u679c", None))
...
"        }\n"
"      ", None))
        self.label_2.setText(QCoreApplication.translate("result", u"\u8bad\u7ec3\u7ed3\u679c", None))
        self.pic_1.setText("")
        self.pic_2.setText("")
        self.pic_3.setText("")
        self.ROC.setText(QCoreApplication.translate("result", u"\u56fe1", None))
        self.p_r.setText(QCoreApplication.translate("result", u"\u56fe2", None))
        self.learn.setText(QCoreApplication.translate("result", u"\u56fe3", None))
        ___qtablewidgetitem = self.tableWidget.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("result", u"\u8bc4\u4ef7\u6307\u6807", None));
        ___qtablewidgetitem1 = self.tableWidget.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("result", u"\u6570\u636e", None));
        self.label.setText(QCoreApplication.translate("result", u"\u5b9e\u9a8cID\uff1a", None))
