...
class Ui_user_main(object):
    def setupUi(self, user_main):
        ...
        sizePolicy.setHeightForWidth(user_main.sizePolicy().hasHeightForWidth())
...
"        ")
    ...
    def retranslateUi(self, user_main):
        user_main.setWindowTitle(QCoreApplication.translate("user_main", u"\u673a\u5668\u5b66\u4e60\u5b9e\u9a8c\u7ba1\u7406\u5e73\u53f0", None))
        self.background_label.setText("")
        self.label_2.setText(QCoreApplication.translate("user_main", u"\u673a\u5668\u5b66\u4e60\u5b9e\u9a8c\u7ba1\u7406\u5e73\u53f0", None))
        self.information.setText(QCoreApplication.translate("user_main", u"\u4e2a\u4eba\u4fe1\u606f", None))
        self.label_3.setText(QCoreApplication.translate("user_main", u"Made by Longlong", None))
        self.train.setText(QCoreApplication.translate("user_main", u"\u6a21\u578b\u8bad\u7ec3", None))
        self.logout.setText(QCoreApplication.translate("user_main", u"\u6ce8\u9500", None))
        self.record.setText(QCoreApplication.translate("user_main", u"\u5b9e\u9a8c\u8bb0\u5f55", None))
        self.username.setText(QCoreApplication.translate("user_main", u"\u6b22\u8fce\u60a8\uff0c", None))
    # retranslateUi
